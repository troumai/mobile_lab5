    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TextView rowPopulation = v.findViewById(R.id.textView2);
                Toast.makeText(context, "Chosen: " + rowName.getText().toString() +" with population: " + rowPopulation.getText().toString(), Toast.LENGTH_SHORT).show();
            }
        });
